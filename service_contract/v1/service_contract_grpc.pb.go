...
func (c *metadataServiceClient) ReportMetadata(ctx context.Context, in *ReportMetadataRequest, opts ...grpc.CallOption) (*ReportMetadataReply, error) {
	...
	err := c.cc.Invoke(ctx, "/io.opensergo.service_contract.v1.MetadataService/ReportMetadata", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _MetadataService_ReportMetadata_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/io.opensergo.service_contract.v1.MetadataService/ReportMetadata",
	}
...
var MetadataService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "io.opensergo.service_contract.v1.MetadataService",
	...
	Metadata: "service_contract/v1/service_contract.proto",
}
